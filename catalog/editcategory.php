...
<div class="edit-nav">
  ...
  <div class="rightsec">
    <p>
      ...
      <input class="text" name="image" id="name" value="<?php echo $cat->get('image'); ?>" placeholder="http://" onClick='window.open("../admin/filebrowser.php?CKEditorFuncNum=1&returnid=image&type=images","mywindow","width=600,height=500")'/>
    </p>
  </div>
